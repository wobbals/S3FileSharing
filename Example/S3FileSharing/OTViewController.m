...
#import <S3FileSharing/OTFileSharingSession.h>
#import "NSData+Compression.h"

@interface OTViewController () <OTFileSharingSessionDelegate>
...
- (void)viewDidLoad
{
    ...
    _session = [[OTFileSharingSession alloc] initWithApiKey:kApiKey
...
connectionCreated:(OTConnection *)connection
{
    ...
    NSLog(@"Sending file with MD5: %@ to connection %@",
          [data md5DigestString], connection);
    // send file to other connection(s)
    [_session sendFile:fileURL toConnection:connection];
}
 ...
 fromConnection:(OTConnection *)connection
{
    ...
    NSLog(@"received MD5 %@ from connection %@",
          [data md5DigestString], connection);
}
